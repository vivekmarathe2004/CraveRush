...
('CraveRush Admin', 'admin@craverush.test', '9822456780', '$2b$12$Y8T6qtbypdEWbxgjDPhfhenyflosL8MLr2u8D6wWpcciQAOdXrjp6', 'admin'),
('CraveRush Customer', 'customer@craverush.test', '9822334455', '$2b$12$vXHRdLZFSyeYOwZ4bh/Ox.glFiDJXShCsYkEMnucHkzz/cM/KZr/u', 'customer');

INSERT INTO addresses (user_id, label, line1, line2, city, pincode, is_default) VALUES
(2, 'Home', '32, MG Road', 'Indiranagar', 'Bengaluru', '560038', 1),
(2, 'Work', '15, Connaught Place', 'Central Delhi', 'New Delhi', '110001', 0);
...
('Mumbai Misal & More', 'Dadar, Mumbai', 'Maharashtrian, Misal', 4.6, 24, 180, 'assets/images/dishes/misal.jpg'),
('Delhi Thali Co.', 'Connaught Place, New Delhi', 'North Indian, Thali', 4.5, 30, 260, 'assets/images/dishes/thali.jpg'),
('Lucknow Kebab House', 'Hazratganj, Lucknow', 'Kebabs, North Indian', 4.3, 28, 320, 'assets/images/dishes/kebab.jpg'),
('Bengaluru Dosa Corner', 'Koramangala, Bengaluru', 'South Indian', 4.4, 22, 220, 'assets/images/dishes/dosa.jpg'),
('Kolkata Chaat Bazaar', 'Park Street, Kolkata', 'Chaat, Street Food', 4.1, 20, 160, 'assets/images/dishes/chaat.jpg'),
('Ahmedabad Veg Thali', 'Law Garden, Ahmedabad', 'Veg Thali, Gujarati', 4.2, 27, 240, 'assets/images/dishes/thali.jpg'),
('Hyderabad Biryani Co.', 'Banjara Hills, Hyderabad', 'Biryani, Mughlai', 4.3, 32, 340, 'assets/images/dishes/biryani.jpg'),
('Pune Sandwich Works', 'Viman Nagar, Pune', 'Sandwiches, Snacks', 4.0, 21, 190, 'assets/images/dishes/vada-pav.jpg'),
('Jaipur Grill House', 'MI Road, Jaipur', 'North Indian, Grill', 4.2, 29, 360, 'assets/images/dishes/kebab.jpg'),
('Chennai Tiffins', 'Anna Nagar, Chennai', 'Home Style, Breakfast', 4.5, 18, 150, 'assets/images/dishes/dosa.jpg'),
('Chandigarh Sweets', 'Sector 17, Chandigarh', 'Desserts, Mithai', 4.4, 24, 220, 'assets/images/dishes/gulab-jamun.jpg'),
('Kochi Cafe', 'Fort Kochi, Kochi', 'Cafe, Beverages', 4.1, 25, 280, 'assets/images/dishes/coffee.jpg');

INSERT INTO menu_items (restaurant_id, item_name, description, category, price, is_veg, image_url, is_active) VALUES
(1, 'House Special Misal Pav', 'Spicy tarri misal with farsan and pav.', 'Misal', 120.00, 1, 'assets/images/dishes/misal.jpg', 1),
...
UPDATE restaurants SET image_url = 'assets/images/dishes/misal.jpg' WHERE name = 'Mumbai Misal & More';
UPDATE restaurants SET image_url = 'assets/images/dishes/thali.jpg' WHERE name = 'Delhi Thali Co.';
UPDATE restaurants SET image_url = 'assets/images/dishes/kebab.jpg' WHERE name = 'Lucknow Kebab House';
UPDATE restaurants SET image_url = 'assets/images/dishes/dosa.jpg' WHERE name = 'Bengaluru Dosa Corner';
UPDATE restaurants SET image_url = 'assets/images/dishes/chaat.jpg' WHERE name = 'Kolkata Chaat Bazaar';
UPDATE restaurants SET image_url = 'assets/images/dishes/thali.jpg' WHERE name = 'Ahmedabad Veg Thali';
UPDATE restaurants SET image_url = 'assets/images/dishes/biryani.jpg' WHERE name = 'Hyderabad Biryani Co.';
UPDATE restaurants SET image_url = 'assets/images/dishes/vada-pav.jpg' WHERE name = 'Pune Sandwich Works';
UPDATE restaurants SET image_url = 'assets/images/dishes/kebab.jpg' WHERE name = 'Jaipur Grill House';
UPDATE restaurants SET image_url = 'assets/images/dishes/dosa.jpg' WHERE name = 'Chennai Tiffins';
UPDATE restaurants SET image_url = 'assets/images/dishes/gulab-jamun.jpg' WHERE name = 'Chandigarh Sweets';
UPDATE restaurants SET image_url = 'assets/images/dishes/coffee.jpg' WHERE name = 'Kochi Cafe';
