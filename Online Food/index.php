...
$topCollege = $pdo->query("SELECT id, name, location, cuisine, rating, eta_minutes, price_for_two, image_url FROM restaurants WHERE location LIKE '%College%' ORDER BY rating DESC LIMIT 8")->fetchAll();
...
<section class="hero-swiggy">
    <div class="hero-content">
        <div class="hero-tag">Food, fast in Nashik</div>
...
<div class="feature-grid">
    <div class="feature-card">
        ...
        <span class="muted">Browse verified Nashik restaurants and curated menus.</span>
    </div>
    <div class="feature-card">
        <div class="feature-icon">??</div>
...
<div class="section-title">
    <h2>Top rated near College Road</h2>
...
<div class="banner-row">
    <div class="banner-card">
        ...
        <span class="muted">Start your day with Nashik favorites.</span>
    </div>
</div>
...
<div class="section-title">
    <h2>Popular Restaurants in Nashik</h2>
...
<div class="cta-band">
    <div>
        ...
        <p>Discover Nashik뭩 best food in minutes with live tracking.</p>
    </div>
